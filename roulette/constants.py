...
BANK_DB = "bank.db"
BANK_SECURITY_THRESHOLD = 2500  # 存款超过此值解锁普通安保：无法被抢劫
BANK_ROYAL_SECURITY_THRESHOLD = 5000  # 存款超过此值解锁皇家安保：无法被抢劫、诱惑、劫富济贫
...
BANK_HEIST_MIN_BALANCE = 1000  # 目标最低存款
...
BIG_RED_PACKET_POOL = 1000  # 奖池 1000 点
BIG_RED_PACKET_MAX_GRABBERS = 10  # 最多 10 人参与
BIG_RED_PACKET_MAX_SHARE = 500  # 单人最多抢到 500 点
